...
//                                                                               NSLocalizedStringFromTable(@"Next", @"BSKeyboardControls", @"Next button title.") ]]];
        ...
        [self setSegmentedControl:[[UISegmentedControl alloc] initWithItems:@[ NSLocalizedString(@"Previous", @""),
        ...
        [self setDoneButton:[[UIBarButtonItem alloc]initWithCustomView:button]];

        
//        [self setDoneButton:[[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"Done", @"")
