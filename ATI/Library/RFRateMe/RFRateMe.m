...
#define kAppStoreAddress @"https://itunes.apple.com/us/app/weather-universal-forecast/id963423076"
#define kAppName @"Weather : Universal Forecast"
...
+(void)showRateAlertAfterTimesOpened:(int)times {
    ...
    NSLog(@"App has been opened %ld times", [defaults integerForKey:@"timesOpened"]);
